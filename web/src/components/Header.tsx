    ...
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Overlay className="fixed bg-black/80 w-screen h-screen inset-0" />

          <Dialog.Content className="absolute bg-zinc-900 rounded-2xl w-full max-w-md p-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
